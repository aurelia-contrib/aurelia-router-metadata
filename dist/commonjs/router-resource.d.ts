...
import { IConfigureRouterInstruction, ICreateRouteConfigInstruction, IResourceLoader, IRouteConfigInstruction, IRouterResourceTarget, IRouterResourceTargetProto } from "./interfaces";
...
export declare class RouterResource {
    ...
    loadOwnRoutes(router?: Router): RouteConfig[];
    /**
