System.register(["aurelia-logging", "./router-metadata", "./router-metadata-configuration"], function (exports_1, context_1) {
    ...
    var aurelia_logging_1, router_metadata_1, router_metadata_configuration_1, configureRouterSymbol, logger, RoutableResource;
    return {
        setters: [
        ...
        execute: function () {
            ...
            logger = aurelia_logging_1.getLogger("router-metadata");
            /**
