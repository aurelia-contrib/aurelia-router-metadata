System.register(['aurelia-pal', 'aurelia-dependency-injection', 'aurelia-router', 'aurelia-logging', 'aurelia-loader'], function (exports, module) {
  'use strict';
  var PLATFORM, Container, RouterConfiguration, AppRouter, getLogger, Loader;
  return {
    setters: [function (module) {
      ...
      RouterConfiguration = module.RouterConfiguration;
    ...
    execute: function () {
      ...
      ***************************************************************************** */
      ...
      })(MapStrategy || (MapStrategy = exports('MapStrategy', {})));
      ...
      const constructorRouteConfigMapper = exports('constructorRouteConfigMapper', commonRouteConfigMapper
          .clone()
          .addMapping("routeName", "name", MapStrategy.overwrite));
      const objectRouteConfigMapper = exports('objectRouteConfigMapper', commonRouteConfigMapper
          .clone()
      ...
      const routerMetadata = exports('routerMetadata', {
          getOwn(target) {
