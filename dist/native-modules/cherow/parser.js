// tslint:disable
import { tokenDesc, descKeyword } from './token';
import { createError } from './errors';
import { isValidIdentifierStart } from './unicode';
import { isQualifiedJSXName, fromCodePoint, invalidCharacterMessage, toHex, isPrologueDirective, hasBit, map, isValidSimpleAssignmentTarget, isValidDestructuringAssignmentTarget, isInOrOfKeyword, isIdentifierStart, isIdentifierPart, getCommentType, isPropertyWithPrivateFieldKey } from './common';
export class Parser {
            ...
            switch (first) {
                ...
                default:
                    if (isValidIdentifierStart(first))
                        return this.scanIdentifier(context);
                    this.report(95 /* InvalidCharacter */, invalidCharacterMessage(first));
            }
        }
        ...
        if (state & 65536 /* Float */) {
            ...
            if (state & (1024 /* Decimal */ | 2048 /* DecimalWithLeadingZero */)) {
                if (isOctal) {
                    ...
                    if (ch !== 46 /* Period */ && !isIdentifierStart(ch)) {
    ...
    parseUpdateExpression(context, pos) {
        ...
        const isPostfix = hasBit(this.token, 2228224 /* IsUpdateOp */) && !(this.flags & 1 /* LineTerminator */);
        if (!prefix && !isPostfix)
            return argument;
        if (context & 512 /* Strict */ &&
    ...
    parseAsyncFunctionExpression(context, pos) {
        ...
        while (this.token !== 16 /* RightParen */) {
            ...
            if (hasBit(this.token, 268435456 /* IsYield */)) {
                this.errorLocation = this.getLocation();
                state |= 32 /* Yield */;
            }
            ...
            if (hasBit(this.token, 134217728 /* IsAwait */)) {
                this.errorLocation = this.getLocation();
                state |= 16 /* Await */;
                this.flags |= 4096 /* HasAwait */;
            }
