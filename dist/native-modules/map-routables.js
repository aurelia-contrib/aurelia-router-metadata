...
var metadataKey = RoutableResource.routableResourceMetadataKey;
export function mapRoutables(moduleId, eagerLoadChildRoutes, filter) {
    var _this = this;
    if (eagerLoadChildRoutes === void 0) { eagerLoadChildRoutes = false; }
    return function (target) {
        var ownModuleId = getModuleId(target);
        RoutableResource.setTarget(ownModuleId, target);
        var resource = metadata.getOrCreateOwn(metadataKey, RoutableResource, target);
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        loader = Container.instance.get(Loader);
                    ...
                    case 2:
                        ...
                        id = moduleIds_1[_i];
                        trg = RoutableResource.getTarget(id);
                        if (trg === undefined) {
                        ...
                        res = metadata.getOwn(metadataKey, trg);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    resource = metadata.getOwn(metadataKey, target);
