...
import { IConfigureRouterInstruction, IRouteConfigInstruction } from "./interfaces";
/**
 ...
 */
export declare function routeConfig(routesOrInstruction?: (RouteConfig | RouteConfig[]) | IRouteConfigInstruction, overrideSettings?: RouterMetadataSettings): ClassDecorator;
/**
