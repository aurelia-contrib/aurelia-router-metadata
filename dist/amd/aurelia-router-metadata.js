define(["require", "exports", "aurelia-dependency-injection", "aurelia-loader", "./registry", "./resource-loader", "./router-metadata", "./router-metadata-configuration", "./router-resource", "./resolution/builders", "./resolution/core", "./resolution/functions", "./resolution/mapping", "./resolution/queries", "./resolution/requests", "./resolution/specifications", "./decorators", "./model", "./registry", "./resource-loader", "./route-config-factory", "./router-metadata-configuration", "./router-metadata", "./router-resource"], function (require, exports, aurelia_dependency_injection_1, aurelia_loader_1, registry_1, resource_loader_1, router_metadata_1, router_metadata_configuration_1, router_resource_1, builders_1, core_1, functions_1, mapping_1, queries_1, requests_1, specifications_1, decorators_1, model_1, registry_2, resource_loader_2, route_config_factory_1, router_metadata_configuration_2, router_metadata_2, router_resource_2) {
    "use strict";
    function __export(m) {
