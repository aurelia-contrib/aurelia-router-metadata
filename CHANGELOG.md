...
<a name="0.10.1"></a>
## [0.10.1](https://github.com/fkleuver/aurelia-router-metadata/compare/v0.10.0...v0.10.1) (2018-03-17)


### Bug Fixes

* **builders:** fix issue where RouteConfig.settings would always be overridden by an empty object ([9cd4943](https://github.com/fkleuver/aurelia-router-metadata/commit/9cd4943))



<a name="0.10.0"></a>
# [0.10.0](https://github.com/fkleuver/aurelia-router-metadata/compare/v0.9.7...v0.10.0) (2018-03-16)


### Features

* **sourcemap:** add sourcemaps to build output ([c5176f8](https://github.com/fkleuver/aurelia-router-metadata/commit/c5176f8))



<a name="0.9.7"></a>
## [0.9.7](https://github.com/fkleuver/aurelia-router-metadata/compare/v0.9.6...v0.9.7) (2018-03-15)


### Bug Fixes

* **initialize:** always check for additional moduleIds [#2](https://github.com/fkleuver/aurelia-router-metadata/issues/2) ([c82e969](https://github.com/fkleuver/aurelia-router-metadata/commit/c82e969))



<a name="0.9.6"></a>
## [0.9.6](https://github.com/fkleuver/aurelia-router-metadata/compare/v0.9.5...v0.9.6) (2018-03-15)


### Bug Fixes

* **initialize:** always check for additional moduleIds ([4d163ca](https://github.com/fkleuver/aurelia-router-metadata/commit/4d163ca))
